...
public class ViewService2Activity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_service2);
        ...
        listView = findViewById(R.id.listService2);
    ...
    private void setUpMaps() {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.ambulanceMap);
    ...
    private void fetchPlaces(String placeType) {
        ...
        call.enqueue(new Callback<PlacesPOJO.Root>() {
            ...
            public void onFailure(Call<PlacesPOJO.Root> call, Throwable t) {
                call.cancel();
                Toast.makeText(ViewService2Activity.this, "Unable to make request", Toast.LENGTH_SHORT);
            }
        });
    }
